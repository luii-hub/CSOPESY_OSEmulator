...
public:
    ...
    bool initialize(ConfigurationManager* newConfigManager, ResourceManager *newResourceManager); // Initialize the scheduler with a configuration manager and
...
private:
    ...
    ResourceManager *resourceManager; // Reference to ResourceManager so can generate quantum memory stamp
